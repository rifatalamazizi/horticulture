...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-title"><h4 style="color:#9057ff;">Edit Brand</h4></div>
                <hr>
                <form action="{{ route('admin.brand.update', $brand->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label for="input-21" class="col-sm-2">Brand Image</label>
                        <div class="col-sm-10 custom-file">
                            <input name="brand_image" type="file" class="" id="brand_image" value="{{ $brand->brand_image }}">
                        </div>
                        <br>
                        <br>
                        <label for="input-21" class="col-sm-2">Brand Old Image</label>
                        <div class="col-sm-10">
                            <img src="{{ asset('public/frontend/assets/images/brands/' . $brand->image) }}" alt="" height="600">
                        </div>
                    </div>
