...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header"><h4 style="color:#9057ff;">Manage Districts</h4></div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="default-datatable" class="table table-bordered datatable">
                        <thead>
                            <tr>
                                <th>District Serial</th>
                                <th>District Name</th>
                                <th>Division Name</th>
                                <th>Action</th>
                            </tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.district.delete', $district->id) }}" class="btn btn-danger"
                                        id="delete">Delete</a>

                                    <a href="{{ route('admin.district.show', $district->id) }}"
