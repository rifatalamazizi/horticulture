...
<div class="row pt-2 pb-2">
    <div class="col-sm-9">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.slider.manage') }}">Manage Slider</a></li>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header"><h4 style="color:#9057ff;">Manage Sliders</h4></div>
            <div class="card-body">
                    ...
                    <table id="default-datatable" class="table table-bordered datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th>Slider Image</th>
                                <td>
                                    <img src="{{ asset('public/backend/images/sliders/' . $slider->image) }}" alt="" height="400">
                                </td>
                            </tr>
