        ...
        <div class="card">
            <div class="card-body">
                <div class="card-title">
                    <h4 style="color:#9057ff;">Edit Category</h4>
                </div>
                <hr>
                <form action="{{ route('admin.category.update', $category->id) }}" method="post"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 custom-file">
                            <input name="category_image" type="file" class="" id="category_image" value="">
                        </div>
                        <br>
                        <br>
                        <label for="input-21" class="col-sm-2">Category Old Image</label>
                        <div class="col-sm-10">
                            <img src="{{ asset('public/frontend/assets/images/category/' . $category->image) }}" alt="" height="600">
                        </div>
                    </div>
