        ...
        <div class="row">
            <div class="col-sm-12 col-lg-6">
                <div class="widget widget-about">
                    <img src="{{ url('public/frontend/assets/images/demos/demo-13/site-logo.png')}}" class="footer-logo" alt="Footer Logo"
                        width="70%" height="70%">
                    ...
                    <div class="widget-about-info">
                        <div class="row">
                            <div class="col-sm-6 col-md-4">
                                ...
                                <a href="tel:123456789" style="color:#A6C76C">+880 13056 92279</a>
                            </div><!-- End .col-sm-6 -->
...
<div class="footer-bottom">
    <div class="container">
        <p class="footer-copyright">All Rights Reserved by Horticulture Center. Develp and Made by Rifat</p>
